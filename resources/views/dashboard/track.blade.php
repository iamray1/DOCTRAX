...
(function(){
    ...
    var TRACK_API_ENDPOINT = {!! json_encode($user->isOfficeAccount() ? '/api/internal/track-document' : '/api/track-document') !!};
    ...
    async function requestTrackData(ref){
        var url = TRACK_API_ENDPOINT + '?ref=' + encodeURIComponent(ref);
