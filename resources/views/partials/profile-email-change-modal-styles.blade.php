        .change-email-link{margin-top:8px;background:transparent;border:0;color:var(--primary);font-family:inherit;font-size:12px;font-weight:600;font-style:italic;cursor:pointer;display:inline-flex;align-items:center;padding:0;width:max-content}
        ...
        .email-modal-close{position:absolute;top:14px;right:14px;width:34px;height:34px;border:0;border-radius:999px;background:#f8fafc;color:#64748b;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:22px;line-height:1}
